...
-- Handles touch events; essentially mouse_click down
...
-- Handles drag events; essentially moving mouse with button down
function event:drag(event_type, screen_addr, x_pos, y_pos, mouse_button, player_name)
    return event_type, screen_addr, x_pos, y_pos, mouse_button, player_name
end

-- Handles drop events; essentially mouse_click up
